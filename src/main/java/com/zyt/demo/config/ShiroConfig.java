...
import com.zyt.demo.util.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/statics/pages/jobInfo", "roles[管理员]");

        //开放登陆接口

        filterChainDefinitionMap.put("/statics/pages/login", "anon");

        //其余接口一律拦截

        //主要这行代码必须放在所有权限设置的最后，不然会导致所有 url 都被拦截

        //filterChainDefinitionMap.put("/statics/pages/jobInfo", "authc");
